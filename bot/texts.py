...
TEXTS: Dict[str, Dict[str, str]] = {
    ...
    "poster_scheduled": {
        ...
        "en": "✅ Post scheduled for <b>{datetime}</b>\nChannel: <b>{channel}</b>",
    },
    "poster_btn_publish_now": {"ru": "Опубликовать сейчас", "en": "Publish now"},
    "poster_btn_tz": {"ru": "Часовой пояс: {value}", "en": "Time zone: {value}"},
    "poster_tz_prompt": {
        "ru": "Укажите свой часовой пояс относительно UTC одним числом.\nНапример: <code>5</code> для UTC+5, <code>-3</code> для UTC−3, <code>3.5</code> для UTC+3:30.",
        "en": "Enter your time zone offset from UTC as a single number.\nFor example: <code>5</code> for UTC+5, <code>-3</code> for UTC−3, <code>3.5</code> for UTC+3:30.",
    },
    "poster_tz_bad": {"ru": "Нужно число от -12 до 14. Например: 5", "en": "Enter a number between -12 and 14. For example: 5"},
    "poster_tz_saved": {"ru": "✅ Часовой пояс сохранён: <b>{value}</b>", "en": "✅ Time zone saved: <b>{value}</b>"},
    "poster_publish_now_done": {
        "ru": "✅ Пост опубликован в <b>{channel}</b>.",
        "en": "✅ Post published to <b>{channel}</b>.",
    },
    "poster_publish_now_failed": {"ru": "Не удалось опубликовать пост.", "en": "Failed to publish the post."},
    "poster_my_posts": {"ru": "<b>Запланированные посты</b>\n\nНажмите на пост, чтобы открыть:", "en": "<b>Scheduled posts</b>\n\nTap a post to open:"},
    "poster_post_detail": {
        "ru": "☝️ <b>Запланированный пост</b>\n\nКанал: <b>{channel}</b>\nПубликация: <b>{datetime}</b>\nПовтор: <b>{repeat}</b>\nID: <code>{post_id}</code>\n\n📤 Показать пост в любом чате: <code>@{bot} {post_id}</code>",
        "en": "☝️ <b>Scheduled post</b>\n\nChannel: <b>{channel}</b>\nPublish at: <b>{datetime}</b>\nRepeat: <b>{repeat}</b>\nID: <code>{post_id}</code>\n\n📤 Show the post in any chat: <code>@{bot} {post_id}</code>",
    },
    "poster_btn_post_inline": {"ru": "Показать / поделиться", "en": "Show / share"},
    ...
    "poster_btn_repeat": {"ru": "Повтор: {value}", "en": "Repeat: {value}"},
    "poster_repeat_prompt": {
        "ru": "🔁 <b>Повтор поста</b>\n\nКак часто повторять публикацию? Каждый цикл создаётся как новый отложенный пост с тем же содержимым.",
        "en": "🔁 <b>Repeat post</b>\n\nHow often to repost? Each cycle is created as a new scheduled post with the same content.",
    },
    ...
    "admin_rejected_deleted": {"ru": "🗑 Заявка удалена", "en": "🗑 Request deleted"},
    "admin_rej_review": {"ru": "Пересмотреть решение", "en": "Review decision"},
    "admin_rej_delete": {"ru": "Удалить заявку", "en": "Delete request"},
    "admin_btn_rejected_appeals": {"ru": "Отклонённые апелляции", "en": "Rejected appeals"},
    "admin_rejected_appeals_title": {
        "ru": "<b>❌ Отклонённые апелляции</b>  (стр. {current}/{total}, всего {count})\n\nНажмите на апелляцию, чтобы пересмотреть решение или удалить.",
        "en": "<b>❌ Rejected appeals</b>  (page {current}/{total}, total {count})\n\nTap an appeal to change the decision or delete it.",
    },
    "admin_rejected_appeals_empty": {"ru": "<b>❌ Отклонённые апелляции</b>\n\nПусто.", "en": "<b>❌ Rejected appeals</b>\n\nEmpty."},
    "admin_rejected_appeal_detail": {
        "ru": "<b>Апелляция</b>\nПользователь: {user} (uid {uid})\n\n<blockquote expandable>{text}</blockquote>",
        "en": "<b>Appeal</b>\nUser: {user} (uid {uid})\n\n<blockquote expandable>{text}</blockquote>",
    },
    ...
    "admin_notify_pref_appeals": {"ru": "Апелляции", "en": "Appeals"},
    "admin_notify_appeal": {
        "ru": "♻️ <b>Апелляция</b>\n\n<b>Заявка:</b> {name}\n<b>Автор:</b> {sender}\n\n<blockquote expandable>{comment}</blockquote>",
        "en": "♻️ <b>Appeal</b>\n\n<b>Submission:</b> {name}\n<b>Author:</b> {sender}\n\n<blockquote expandable>{comment}</blockquote>",
    },
    "admin_notify_author_reply": {
        "ru": "💬 <b>Ответ автора</b>\n\n<b>Заявка:</b> {name}\n<b>Автор:</b> {sender}\n\n<blockquote expandable>{text}</blockquote>",
        "en": "💬 <b>Author's reply</b>\n\n<b>Submission:</b> {name}\n<b>Author:</b> {sender}\n\n<blockquote expandable>{text}</blockquote>",
    },
    "admin_notify_pref_author_replies": {"ru": "Ответы авторов", "en": "Author replies"},
    ...
    "modcontact_sent": {
        ...
        "en": "✅ Your question was sent to moderation. The reply will arrive here.",
    },
    "modcontact_failed": {
        "ru": "Не удалось отправить вопрос. Попробуйте позже.",
    ...
    "appeal_prompt_comment": {
        ...
        "en": "♻️ <b>Appeal for «{name}»</b>\n\nExplain in detail why the decision should be reconsidered: what you fixed or why the rejection was wrong.\n\n⚠️ This is the final attempt: if it is rejected again, the plugin will be blocked permanently.",
    },
    ...
    "appeal_not_a_plugin": {
        ...
        "en": "This is a ban appeal — use the appeal buttons, not publishing.",
    },
    "appeal_forum_badge": {
        "ru": "🚫 <b>Это апелляция бана</b>, а не плагин. «За» = разбанить, «Отказать» = оставить бан.",
        "en": "🚫 <b>This is a ban appeal</b>, not a plugin. \"Yes\" = unban, \"Reject\" = keep the ban.",
    },
    "appeal_request_title": {"ru": "Апелляция бана — {user}", "en": "Ban appeal — {user}"},
    "appeal_request_draft": {
        "ru": "🚫 <b>Апелляция бана</b>\n\n<b>Пользователь:</b> {user} (uid {uid})\n\n<blockquote expandable>{text}</blockquote>",
        "en": "🚫 <b>Ban appeal</b>\n\n<b>User:</b> {user} (uid {uid})\n\n<blockquote expandable>{text}</blockquote>",
    },
    "appeal_already_used": {
        "ru": "Апелляция по этой заявке уже подавалась.",
        "en": "An appeal for this submission was already used.",
    },
    "plugin_blocked": {
        "ru": "🚫 Этот плагин заблокирован: апелляция была отклонена. Повторная отправка невозможна.",
        "en": "🚫 This plugin is blocked: the appeal was rejected. It cannot be submitted again.",
    },
    "notify_rejected_blocked": {
        "ru": "\n\n🚫 <b>Плагин заблокирован.</b> Апелляция отклонена, повторная отправка этого плагина невозможна.",
        "en": "\n\n🚫 <b>Plugin blocked.</b> The appeal was rejected, this plugin can no longer be submitted.",
    },
    "admin_appeal_badge": {
        "ru": "♻️ <b>АПЕЛЛЯЦИЯ</b> (последняя попытка — при отказе плагин блокируется)\n<b>Комментарий автора:</b>\n<blockquote expandable>{comment}</blockquote>",
        "en": "♻️ <b>APPEAL</b> (final attempt — rejection blocks the plugin)\n<b>Author's comment:</b>\n<blockquote expandable>{comment}</blockquote>",
    },
    ...
    "err_text_too_long_resent": {
        "ru": "Текст слишком длинный для редактирования, открыл новым сообщением.",
        "en": "The text is too long to edit, sent it as a new message.",
    },
    "err_update_message_failed": {"ru": "Не удалось обновить сообщение: {error}", "en": "Failed to update the message: {error}"},
    "admin_new_forum_only": {
        "ru": "Команда /new работает только в форуме модерации.",
        "en": "The /new command only works in the moderation forum.",
    },
    "admin_schedule_unsupported_type": {
        "ru": "Для этого типа заявки отложка не поддерживается",
        "en": "Scheduling is not supported for this request type",
    },
    "admin_generic_error": {"ru": "Ошибка:\n<code>{error}</code>", "en": "Error:\n<code>{error}</code>"},
    "admin_current_value": {"ru": "<b>Текущая:</b> <code>{value}</code>", "en": "<b>Current:</b> <code>{value}</code>"},
    "admin_channel_message_missing": {"ru": "Сообщение канала не найдено", "en": "Channel message not found"},
    "admin_updating": {"ru": "Обновление...", "en": "Updating..."},
    "admin_userbot_unavailable": {"ru": "Userbot недоступен", "en": "Userbot is unavailable"},
    "admin_publish_stopped": {"ru": "<b>Публикация остановлена</b>\n\n{errors}", "en": "<b>Publishing stopped</b>\n\n{errors}"},
    "admin_has_errors": {"ru": "Есть ошибки", "en": "There are errors"},
    ...
    "kb_vote_reason_tpl": {"ru": "Причина по шаблону", "en": "Reason from template"},
    "kb_vote_reason_own": {"ru": "Своя причина", "en": "Custom reason"},
    "kb_vote_reason_skip": {"ru": "Без причины", "en": "Without a reason"},
    "kb_vote_cancel": {"ru": "Отмена голоса", "en": "Cancel vote"},
    "vote_reason_title": {
        "ru": "🗳 Голосует: {moderator}\nГолос: <b>{vote}</b>\nПлагин: {name}\n\nУкажите причину — без неё голос не будет засчитан.\n<i>Сообщение исчезнет через минуту.</i>",
        "en": "🗳 Voting: {moderator}\nVote: <b>{vote}</b>\nPlugin: {name}\n\nProvide a reason — the vote won't count without one.\n<i>This message disappears in a minute.</i>",
    },
    "vote_reason_title_optional": {
        "ru": "🗳 Голосует: {moderator}\nГолос: <b>{vote}</b>\nПлагин: {name}\n\nВыберите причину или проголосуйте без неё.\n<i>Сообщение исчезнет через минуту.</i>",
        "en": "🗳 Voting: {moderator}\nVote: <b>{vote}</b>\nPlugin: {name}\n\nPick a reason or vote without one.\n<i>This message disappears in a minute.</i>",
    },
    "vote_reason_pick_tpl": {"ru": "🗳 {moderator}, выберите шаблон причины:", "en": "🗳 {moderator}, pick a reason template:"},
    "vote_reason_enter_own": {
        "ru": "Отправьте свою причину ответом на это сообщение.",
        "en": "Send your reason as a reply to this message.",
    },
    "vote_reason_own_prompt": {
        "ru": "🗳 Голосует: {moderator}\nГолос: <b>{vote}</b>\nПлагин: {name}\n\n✏️ Отправьте свою причину <b>ответом на это сообщение</b>.\n<i>Сообщение исчезнет через минуту.</i>",
        "en": "🗳 Voting: {moderator}\nVote: <b>{vote}</b>\nPlugin: {name}\n\n✏️ Send your reason as a <b>reply to this message</b>.\n<i>This message disappears in a minute.</i>",
    },
    "vote_value_yes": {"ru": "За", "en": "Yes"},
    "vote_value_no": {"ru": "Отказать", "en": "Reject"},
    "vote_saved": {"ru": "Голос учтён", "en": "Vote counted"},
    "vote_cancelled": {"ru": "Голос отменён", "en": "Vote cancelled"},
    "vote_expired": {"ru": "Голосование неактуально", "en": "This vote is no longer active"},
    "vote_not_yours": {"ru": "Это голос {moderator} — нажимать может только он", "en": "This vote belongs to {moderator} — only they can use it"},
    "vote_timeout": {"ru": "Время на выбор причины истекло — голос не засчитан", "en": "Time to pick a reason expired — vote not counted"},
    "vote_anon_on_alert": {"ru": "Голос будет анонимным", "en": "Vote will be anonymous"},
    "vote_anon_off_alert": {"ru": "Голос будет с вашим именем", "en": "Vote will show your name"},
    ...
    "kb_appeal_banfinal": {"ru": "Отклонить окончательно", "en": "Deny permanently"},
    "appeal_prompt": {
    ...
    "appeal_banned_final": {
        "ru": "🚫 Ваша апелляция отклонена окончательно. Блокировка окончательная, новые апелляции не принимаются.",
        "en": "🚫 Your appeal was denied for good. The ban is permanent and no further appeals are accepted.",
    },
    "appeal_permanently_denied": {
        "ru": "Блокировка окончательная — апелляции больше не принимаются.",
        "en": "The ban is permanent — appeals are no longer accepted.",
    },
    "appeal_done_unban": {"ru": "Пользователь разблокирован", "en": "User unbanned"},
    "appeal_done_deny": {"ru": "Апелляция отклонена", "en": "Appeal denied"},
    "appeal_done_banfinal": {"ru": "Отклонено окончательно, апелляции закрыты", "en": "Denied permanently, appeals closed"},
    ...
    "admin_cfg_moderation_require_vote_reason": {"ru": "Причина при голосовании", "en": "Reason required to vote"},
    "admin_cfg_moderation_send_reasons_to_author": {"ru": "Причины автору по умолчанию", "en": "Send reasons to author by default"},
    "admin_btn_audit_log": {"ru": "Журнал действий", "en": "Action log"},
    "admin_btn_blocklist": {"ru": "Блок-лист", "en": "Blocklist"},
    "admin_audit_log_title": {
        "ru": "<b>📜 Журнал действий</b>  (стр. {current}/{total}, всего {count})\n\n{events}",
        "en": "<b>📜 Action log</b>  (page {current}/{total}, total {count})\n\n{events}",
    },
    "admin_audit_log_empty": {"ru": "<b>📜 Журнал действий</b>\n\nПусто.", "en": "<b>📜 Action log</b>\n\nEmpty."},
    "admin_blocklist_title": {
        "ru": "<b>🚫 Заблокированные плагины</b> ({count})\n\nПлагины, чья апелляция была отклонена. Нажмите, чтобы разблокировать.",
        "en": "<b>🚫 Blocked plugins</b> ({count})\n\nPlugins whose appeal was rejected. Tap to unblock.",
    },
    "admin_blocklist_empty": {"ru": "<b>🚫 Заблокированные плагины</b>\n\nСписок пуст.", "en": "<b>🚫 Blocked plugins</b>\n\nThe list is empty."},
    "admin_unblocked": {"ru": "✅ Плагин разблокирован: {id}", "en": "✅ Plugin unblocked: {id}"},
    ...
    "rules_before_submit": {
        "ru": "Обязательно прочитайте правила распространения плагинов перед отправкой заявки администратору: https://t.me/exteraPluginsSup/93",
        "en": "Please read the plugin distribution rules before sending your request to the admins: https://t.me/exteraPluginsSup/93",
    },
    "icons_title": {
